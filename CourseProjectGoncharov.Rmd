...
setwd("D:/Research/Machine Learning/project")
...
Accuracy is 64% which is not so good. We can try random forest to bag our predictors as one of the most accurate models.
...
Random forest seems to be very accurate method for resolving this type of task (Accuracy = 0.999).
...
We get very close accuracy for them - 0.9998.
